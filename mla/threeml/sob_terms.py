...
class ThreeMLPSEnergyTermFactory(sob_terms.SoBTermFactory):
    ...
    def cal_sob_map(self) -> np.ndarray:
        ...
        ratio[1:sig_h.shape[0]-1,1:sig_h.shape[1]-1] = convolve2d(ratio, kernel, mode='valid')
        return ratio
    ...
    def generate_config(cls):
        ...
        config["sin_dec_bins"] = 100
        config["log_energy_bins"] = 100
...
@dataclasses.dataclass
class dummy_ThreeMLPSEnergyTermFactory(ThreeMLPSEnergyTermFactory):
    """Docstring"""
